    ...
    <>
      <Snackbar open={alertOpen} autoHideDuration={3000} onClose={handleClose}>
        <MuiAlert
          ...
          severity="warning"
        >
          "This React App is developed by Vibhu Dhyani . All rights are
          reserved."
        </MuiAlert>
      </Snackbar>
      ...
      <div className="app">
        ...
        <Header />
        <div>
          <img id="wave" src={images.wave} />
        </div>
        <About />
        <div>
          <img id="wave1" src={images.wave} />
        </div>
        <Work />
        <div>
          <img id="wave" src={images.wave} />
        ...
        <div className="icon-bar">
          <SocialIcon
            className="icon1"
            url="https://www.instagram.com/vicinity._dynamo/"
          />

          <SocialIcon
            className="icon2"
            url="https://www.linkedin.com/in/vibhu-dhyani-930373208/"
          />

          <SocialIcon className="icon3" url="https://github.com/Vibhu-Dhyani" />
          {/*<div className="icon4">
            <a href="https://leetcode.com/vibhudhyani28/" target='_blank'>
